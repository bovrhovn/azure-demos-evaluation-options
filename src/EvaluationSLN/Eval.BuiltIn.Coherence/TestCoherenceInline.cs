...
public class TestsCoherenceInline
{
    ...
    public async Task BuiltinInlineData()
    {
        ...
        var fields = ParseClientResult(evaluation, ["name", "id"]);
        ...
        var evaluationResults = await GetResultsListAsync(client: evaluationClient, evaluationId: evaluationId, evaluationRunId: runId);
